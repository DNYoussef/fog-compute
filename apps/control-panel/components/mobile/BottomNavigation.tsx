...
import { Home, Server, ListTodo, Shield, MessageSquare, BarChart } from 'lucide-react';
...
const navItems: NavItem[] = [
  ...
  { label: 'Nodes', href: '/nodes', icon: Server, testId: 'bottom-nav-nodes' },
  { label: 'Tasks', href: '/tasks', icon: ListTodo, testId: 'bottom-nav-tasks' },
