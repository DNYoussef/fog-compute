...
- CI agrees with local regression results or failures are triaged. **Contract dependency/config failures are triaged in PR #31; E2E matrix failure is triaged to the Playwright web-server Python import path and fixed in PR #33.**
