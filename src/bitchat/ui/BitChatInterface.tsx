/**
 * BitChat Interface Component
 * Main UI for P2P mesh messaging
 */
    ...
    <div className="bitchat-interface">
      <div className="bitchat-header">
        <div className="header-title">
          ...
          <span className={`encryption-badge ${encryptionStatus.enabled ? 'enabled' : ''}`}>
            {encryptionStatus.enabled ? 'Encrypted' : 'Not Encrypted'} ({encryptionStatus.protocol})
          </span>
        </div>
        ...
        <div className="conversation-area">
          {selectedPeerData ? (
            ...
            <div className="no-conversation">
              <div className="no-conversation-icon">Chat</div>
      ...
      <div className="bitchat-status">
        ...
        <div className="status-item">
          ...
          <span className={`status-value ${meshStatus.health}`}>
            {meshStatus.health === 'good' ? 'Good' : meshStatus.health === 'fair' ? 'Fair' : 'Poor'}
          </span>
        </div>
        <div className="status-item">
