 ...
 * Display message thread and input for a selected peer
 */
              ...
              >
                <div className="message-content">
                  ...
                  <div className="message-meta">
                    ...
                    {message.encrypted && <span className="encrypted-badge">Encrypted</span>}
                    <span className={`delivery-status ${message.deliveryStatus}`}>
                      {message.deliveryStatus === 'delivered' ? 'Delivered' :
                       message.deliveryStatus === 'read' ? 'Read' : 'Sent'}
                    </span>
                  </div>
                </div>
              </div>
